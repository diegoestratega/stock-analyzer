...
def _compute_score(f: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {"score_100": score_100, "rating": _rating_from_score(score_100), "breakdown": breakdown}
...
def api_analyze_get(ticker: str):
    return _build_analysis(ticker)


@app.post("/api/analyze")
def api_analyze_post(req: AnalyzeRequest):
